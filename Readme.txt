...
3.Right click on the project and select  'import' -> file systems -> browse and add the extracted files ASOS-ASSIGNMENT. Please select ASOS-ASSIGNMENT. Makesure .classpath and .project and geckodriver.exe file are included (Note - Please dont add as zip file)
